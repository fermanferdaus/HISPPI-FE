...
export default function StrukturAdd() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.message || "Gagal menambahkan data struktur.");
      } else {
    ...
    <div className="p-4">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">
          Lengkapi formulir berikut untuk menambahkan pengurus baru DPP HISPPI
          PNF.
        </p>
      </div>
